@tool
class_name AcousticAudioSettings extends RefCounted

const PluginPrefixName: String = "acoustic" ## The folder name
const GitRepositoryName: String = "acoustic"

static var PluginName: String = "Acoustic"
...
static var AudioManagerSingleton: String = "AcousticAudioManager"
static var MusicManagerSingleton: String = "AcousticMusicManager"
static var SoundPoolSingleton: String = "AcousticSoundPool"


static func setup_sound_pool_settings() -> void:
	## https://github.com/godotengine/godot/issues/56598
	var setting_name: String = AcousticAudioSettings.SoundPoolAmountSetting
