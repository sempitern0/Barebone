@icon("res://ui/content/warnings/content_warning.svg")
class_name ContentWarningDisplayer extends Control
...
func _unhandled_input(_event: InputEvent) -> void:
	if OmniKitInputHelper.action_just_pressed_and_exists(InputControls.SkipContentWarning):
