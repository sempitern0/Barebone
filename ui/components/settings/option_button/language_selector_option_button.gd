...
var languages_included: Array[OmniKitLocalization.Language] = [
	OmniKitLocalization.english(),
	OmniKitLocalization.spanish(),
	OmniKitLocalization.portuguese(),
	OmniKitLocalization.italian(),
	OmniKitLocalization.german(),
	OmniKitLocalization.french(),
	OmniKitLocalization.russian()
]
