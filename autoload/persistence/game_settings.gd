...
const InvertLookSetting: StringName = &"invert_look"
const InvertXAxisSetting: StringName = &"invert_x_axis"
const InvertYAxisSetting: StringName = &"invert_y_axis"
...
const LeftHandedSetting: StringName = &"left_handed"
