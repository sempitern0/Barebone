...
func _create_turn_direction_timer():
	if turn_direction_timer == null:
		turn_direction_timer = OmniKitTimeHelper.create_idle_timer(maxf(0.05, change_rotation_direction_after_seconds), false, true)
	...
	OmniKitNodeTraversal.set_owner_to_edited_scene_root(turn_direction_timer)
