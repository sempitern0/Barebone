## A static camera that rotates and points at a target, often controlled by the position of the mouse. 
## It is typical of point-and-click or mystery games, and offers a dynamic security view.
class_name StaticFixedCamera3D extends Node3D
