@icon("res://components/3D/camera/free_look/free_look_camera.svg")
...
func on_mouse_sensitivity_changed(_section: String, key: String, value: Variant) -> void:
	if key == GameSettings.MouseSensivitySetting:
