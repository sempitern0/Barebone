@icon("res://components/3D/dungeon_crawler/motion/dungeon_controller.svg")
class_name DungeonCrawlerController extends Node3D

@onready var dungeon_grid_movement: DungeonGridMovement3D = $DungeonGridMovement3D
